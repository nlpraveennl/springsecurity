...
<body>
	<div class="container-fluid wrapper">
		<div class="row header">
			...
			<div class="col-md-4 offset-6 user-info-session-control-box">
				<div class="row">
					...
					<div class="col-md-4 header-item">
						...
						<span>
							<form:form action="${pageContext.request.contextPath}/logout" method="POST" modelAttribute="loggedInUser">
								<form:button type="submit"><span class="logout-label"><spring:message code="app.header.logout.label"/></form:button>
							</form:form>
						</span>
					</div>
				</div>
		...
		<div class="row content">
			<div class="col-md-2 col-sm-2 col-xs-2 sidebar">
				...
				<div class="menu-item">
					<form:form action="${pageContext.request.contextPath}/app/user/dashboard" method="POST" modelAttribute="loggedInUser">
						<form:button type="submit">
							<span class="logout-label"><spring:message code="app.dashboard.label"/></span>
						</form:button>
					</form:form>
				</div>
			</div>
...
// history.pushState({}, null, '<c:url value="/app/user/dashboard" />');
</script>
</html>