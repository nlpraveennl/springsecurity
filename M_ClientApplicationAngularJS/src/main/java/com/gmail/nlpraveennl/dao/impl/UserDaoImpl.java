...
public class UserDaoImpl implements UserDao
{
	...
	public UserDetails getMyDetails(String userName)
	{
		try (Session session = sessionFactory.openSession();)
		{
			TypedQuery<UserDetails> query = session.createQuery("SELECT NEW com.gmail.nlpraveennl.model.UserDetails"
					+ "(id, firstName, lastName, userName, email, gender, enabled) FROM UserDetails WHERE userName = '"+userName+"'", UserDetails.class);
